...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "fa21_3308_tuj55883?user=tuj55883&password=oaxiexee";
    ...
    private void recordError(String errorMsg) {
        ...
        System.out.println("Database unavailable - please try later or contact your administrator. "
                + "Error in DbConn. " + errorMsg);
    }
    ...
    private boolean isTemple() {
        ...
        try {
            ...
            recordError("Database unavailable - please try later or contact your administrator. "
                    + "Unable to get hostName: " + e.getMessage());
        }
        return temple;
    }
