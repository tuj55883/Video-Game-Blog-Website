...
public class DbMods {
    ...
    public static StringData findByEmailPassword(DbConn dbc, String userEmail, String password) {
        ...
        try {
            ...
            if (results.next()) { // id is unique, one or zero records expected in result set
                ...
                sd.errorMsg = "Web User Not Found. Please enter correct Email and Password.";
            }
            results.close();
            stmt.close();
        } catch (Exception e) {
            sd.errorMsg = "Exception thrown in DbMods.findByEmailPassword(): " + e.getMessage();
        }
        return sd;
    ...
    public static String delete(String userId, DbConn dbc) {
        ...
        if (userId == null) {
            return "Cannot delete the selected web user because the 'userId' is null";
        }
        ...
        try {
            ...
            result = "This user could not be deleted because there are posts associated with their account";
        }
