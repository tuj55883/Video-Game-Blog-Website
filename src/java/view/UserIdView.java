    ...
    public static StringDataList getAllIds(DbConn dbc) {
        ...
        try {
            ...
            while (results.next()) {
                ...
                StringData userId = new StringData();
                userId.webUserId = FormatUtils.formatInteger(results.getObject("web_user_id"));
                userId.userEmail = FormatUtils.formatString(results.getObject("user_email"));
